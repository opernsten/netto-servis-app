...
const CustomerDetail = () => {
  ...
  return (
    // 1. POZADÍ STRÁNKY: Slate-100 (dostatečně tmavá šedá pro kontrast s bílou)
    <div className="min-h-screen bg-slate-100 pb-12 font-sans text-slate-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* ZMĚNA: border-slate-300 a silnější stín, aby to bylo vidět */}
        <div className="bg-white rounded-2xl border border-slate-300 shadow-xl shadow-slate-300/50 overflow-hidden mb-8">
            ...
            <div className="p-8 bg-slate-50">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {/* DLAŽDICE 1: Kontakt - ZMĚNA: border-slate-300 pro viditelnost */}
                    <div className="bg-white p-6 rounded-xl border border-slate-300 shadow-sm hover:shadow-lg hover:border-blue-500 transition-all duration-300 group">
                    ...
                    <div className="bg-white p-6 rounded-xl border border-slate-300 shadow-sm hover:shadow-lg hover:border-blue-500 transition-all duration-300">
                        <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-5 flex items-center gap-2 border-b border-slate-200 pb-2">
                            Fakturační údaje
                        </h3>
                        <div className="space-y-4">
        ...
        {/* 3. KARTA S DATY (Tabulky) - ZMĚNA: border-slate-300 */}
