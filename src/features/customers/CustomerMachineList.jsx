...
import { Wrench, MapPin, ChevronRight, CheckCircle2, AlertTriangle, Ban } from 'lucide-react';
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                    <thead className="bg-slate-50 text-slate-500 uppercase text-[11px] font-bold tracking-wider border-b border-slate-200">
                        <tr>
                            <th className="px-6 py-4 font-bold">Název stroje</th>
                            <th className="px-6 py-4 font-bold">Stav</th> {/* NOVÝ SLOUPEC */}
